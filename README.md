...
Uses large-scale simulation to confirm that P(Y > a + b | Y > a) = P(Y > b) holds numerically for the Geometric distribution. Bridges the gap between the algebraic proof and empirical evidence.
`R Markdown` `Simulation` `Geometric`
